...
if __name__ == '__main__':
    ...
    #filename = r'w:\outer_world\Shapefiles\CityPOI.dbf'
    #\\tj-map16\TA1306\TATest_ALL_AP\shp\shpd\BRN\brn
    filename = r'\\tj-map16\TA1306\TATest_ALL_AP\shp\shpd\BRN\brn\brnbrn___________rf.dbf'
    if len(sys.argv) == 2:
        filename = sys.argv[1]
    f = open(filename, 'rb')
    db = list(dbfreader(f))
